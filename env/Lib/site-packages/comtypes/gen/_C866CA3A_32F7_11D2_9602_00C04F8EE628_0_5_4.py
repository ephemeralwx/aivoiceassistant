...
__all__ = [
    'SPPS_Interjection', 'SITooQuiet', 'DISPID_SGRClear',
    'DISPID_SRCEAudioLevel', 'SVP_11', 'DISPID_SOTCategory',
    'SPFM_CREATE_ALWAYS', 'SVF_Emphasis', 'ISpeechXMLRecoResult',
    'DISPID_SGRsAdd', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SLWs_NewEnum', 'DISPID_SOTIsUISupported',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SAFGetWaveFormatEx',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPADAPTATIONRELEVANCE',
    'eLEXTYPE_PRIVATE14', 'DISPID_SOTDataKey', 'ISpXMLRecoResult',
    'SAFT8kHz8BitStereo', 'Speech_Default_Weight', 'SRSActive',
    'SAFTGSM610_44kHzMono', 'SPSVerb', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVSInputSentenceLength', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SAStatus', 'DISPID_SRGetPropertyString',
    'SRERecoOtherContext', 'DISPID_SPRsCount',
    'SGDSActiveUserDelimited', 'DISPID_SVSPhonemeId',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPAsCount',
    'DISPID_SGRInitialState', 'DISPID_SpeechLexiconProns',
    'DISPID_SRCVoice', 'SP_VISEME_6', 'DISPID_SPAsItem',
    'SPAR_Unknown', 'SAFT48kHz16BitMono', 'SpeechVisemeFeature',
    'SPSUnknown', 'SPSLMA', 'ISpDataKey', 'SpeechAudioState',
    'SPRS_ACTIVE', 'DISPID_SLWPronunciations',
    'ISpPhoneticAlphabetConverter', 'ISpeechVoiceStatus',
    'SAFT44kHz16BitStereo', 'SVP_0', 'SPEI_START_INPUT_STREAM',
    'SVEWordBoundary', 'SP_VISEME_15', 'SAFT22kHz8BitStereo',
    'SpeechRuleState', 'SWPUnknownWordUnpronounceable', 'SPAS_RUN',
    'DISPID_SVGetAudioOutputs', 'SVP_13',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SLRemovePronunciation', 'SPDKL_LocalMachine',
    'SRAORetainAudio', 'ISpObjectTokenCategory', 'ISpObjectToken',
    'SRCS_Enabled', 'SPRST_NUM_STATES', 'DISPID_SPRuleParent',
    'SPCS_ENABLED', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SLPsCount', 'SpeechRecoProfileProperties',
    'SPSERIALIZEDPHRASE', 'ISpeechBaseStream', 'DISPID_SLPs_NewEnum',
    'SAFT12kHz8BitStereo', 'SpeechMicTraining', 'STCInprocServer',
    'SPGRAMMARSTATE', 'SpeechDataKeyLocation', 'SPSTREAMFORMATTYPE',
    'SWPKnownWordPronounceable', 'SPEI_SOUND_START',
    'DISPID_SPRuleChildren', 'SpeechPropertyResponseSpeed',
    'ISpeechRecoGrammar', 'SITooFast', 'ISpeechAudio',
    'DISPID_SGRSTsCount', 'SAFT22kHz8BitMono', 'DISPID_SPILanguageId',
    'SAFTDefault', 'DISPID_SPEsCount', 'SPSNotOverriden',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPIRetainedSizeBytes', 'ISpeechGrammarRuleState',
    'SPSSuppressWord', 'DISPID_SLPsItem', 'SRTEmulated',
    'SPEI_END_INPUT_STREAM', 'SGRSTTDictation',
    'eLEXTYPE_USER_SHORTCUT', 'eLEXTYPE_RESERVED8',
    'DISPID_SRCRetainedAudio', 'SPFM_OPEN_READWRITE',
    'SPEI_HYPOTHESIS', 'SpeechRegistryLocalMachineRoot', 'SRADynamic',
    'SPLO_STATIC', 'ISpeechMemoryStream', 'SpInprocRecognizer',
    'DISPID_SWFEBlockAlign', 'SPEI_RESERVED2',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SABufferNotifySize', 'eLEXTYPE_RESERVED9',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPIAudioSizeTime',
    ...
    'SP_VISEME_18', 'DISPID_SDKOpenKey', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SGRsCommitAndSave', 'SBOPause',
    'DISPID_SASFreeBufferSpace', 'SPEI_START_SR_STREAM',
    'DISPID_SpeechLexiconWord', 'SpeechSpecialTransitionType',
    'DISPID_SRCESoundStart', 'SPEI_SR_BOOKMARK',
    'SpUnCompressedLexicon', 'DISPID_SRCEBookmark', 'SPWORDLIST',
    'DISPID_SVSRunningState', 'SP_VISEME_1', 'SVP_2', 'SASPause',
    'DISPID_SVRate', 'DISPID_SWFEChannels', 'SP_VISEME_11',
    'SpeechTokenShellFolder', 'ISpeechRecoResult2',
    'SRSInactiveWithPurge', 'DISPID_SOTCDefault',
    'DISPID_SCSBaseStream', 'SAFT16kHz16BitStereo',
    'DISPID_SpeechFileStream', 'SPSFunction',
    'SPEI_RECO_STATE_CHANGE', 'ISpeechVoice', 'DISPID_SRGRecoContext',
    'SGRSTTWord', 'DISPID_SLWLangId', 'LONG_PTR', 'SDTReplacement',
    'SGLexical', 'DISPID_SVPriority', 'DISPID_SLWsItem',
    'SpeechRecognitionType', 'eLEXTYPE_PRIVATE16',
    'SAFTExtendedAudioFormat', 'SGDSActive', 'SPSMF_SAPI_PROPERTIES',
    'SREAudioLevel', 'SPAO_NONE', 'DISPID_SMSALineId',
    'SSFMCreateForWrite', 'SDTAll', 'SpeechBookmarkOptions',
    'SpMemoryStream', 'SPBO_TIME_UNITS', 'SPWT_LEXICAL',
    'SPPS_Unknown', 'IInternetSecurityMgrSite',
    'SPDKL_DefaultLocation', 'DISPID_SGRAddState',
    'DISPID_SpeechDataKey', 'SITooSlow',
    'SpeechCategoryPhoneConverters', 'DISPID_SASState', 'SGRSTTRule',
    'DISPID_SVSLastResult', 'SpeechVisemeType',
    'DISPID_SRRTOffsetFromStart', 'SWTDeleted',
    'DISPIDSPTSI_ActiveLength', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPVPRI_OVER', 'ISpResourceManager', 'DISPIDSPTSI',
    'DISPID_SRRTimes', 'SPEI_SR_PRIVATE', 'DISPID_SRCRecognizer',
    'DISPID_SVEWord', 'SAFT32kHz8BitStereo', '_ISpeechVoiceEvents',
    'ISpeechRecognizer', 'DISPID_SPRulesCount',
    'DISPID_SWFEExtraData',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPAUDIOBUFFERINFO',
    'SLTUser', 'DISPID_SVSVisemeId', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPDKL_CurrentUser', 'SPRULE', 'DISPID_SRSCurrentStreamPosition',
    'SpeechRecoContextState', 'DISPID_SVSpeakCompleteEvent',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPPValue', 'SVEVoiceChange',
    'SpeechTokenValueCLSID', 'SWTAdded', 'ISpeechRecoContext',
    'SPINTERFERENCE_TOOSLOW', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'ISpeechGrammarRules', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SGRsDynamic', 'SPEI_FALSE_RECOGNITION',
    'SPINTERFERENCE_TOOQUIET', 'SpeechRetainedAudioOptions',
    'DISPID_SRSCurrentStreamNumber', 'SpeechAudioVolume',
    'SAFTCCITT_ALaw_44kHzMono', 'eLEXTYPE_APP', 'SPEI_TTS_PRIVATE',
    'SPPS_RESERVED1', 'SREPhraseStart', 'DISPID_SRGetPropertyNumber',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRRAudioFormat',
    'DISPID_SLRemovePronunciationByPhoneIds', 'eLEXTYPE_RESERVED7',
    'DISPID_SPRuleConfidence', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SVGetAudioInputs', 'SpeechGrammarWordType',
    'SpeechInterference', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SVPause', 'SPDKL_CurrentConfig', 'SPWORD',
    'SECNormalConfidence', 'DISPID_SDKGetBinaryValue',
    'DISPID_SpeechPhraseElements', 'DISPID_SGRSTransitions',
    'DISPID_SVStatus', 'DISPID_SpeechPhraseProperties',
    'SAFTADPCM_44kHzMono', 'DISPID_SpeechPhraseRule',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SLWWord', 'SVSFVoiceMask',
    'DISPID_SPIEnginePrivateData', 'ISpProperties',
    'DISPID_SpeechMemoryStream', 'DISPID_SRGetFormat', 'SVP_16',
    'SpSharedRecognizer', 'DISPID_SGRSAddWordTransition',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechCategoryAppLexicons', 'SAFTCCITT_ALaw_22kHzMono',
    'SP_VISEME_0', 'DISPID_SRCSetAdaptationData', 'DISPID_SRGCommit',
    'DISPID_SPEs_NewEnum', 'SpeechCategoryVoices', 'DISPID_SAFType',
    'SRSEDone', 'DISPID_SABIBufferSize', 'DISPID_SGRSTType',
    'DISPID_SAVolume', 'Speech_StreamPos_Asap', 'SPGRAMMARWORDTYPE',
    'DISPID_SpeechPhraseReplacements', 'ISpeechPhraseElements',
    'DISPID_SRRSaveToMemory', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRGCmdLoadFromMemory', 'SGSEnabled',
    'DISPID_SWFEAvgBytesPerSec', 'SVEAllEvents', 'SRTExtendableParse',
    'SPVPRIORITY', 'SVP_18', 'SPXRO_Alternates_SML', 'SpCustomStream',
    'ISpeechAudioFormat', 'DISPID_SMSGetData', 'DISPID_SPCIdToPhone',
    'SP_VISEME_2', 'SECHighConfidence', 'SPSEMANTICFORMAT',
    'SpeechGrammarTagDictation', 'DISPID_SOTRemoveStorageFileName',
    ...
    'SpeechGrammarTagUnlimitedDictation', 'SpNotifyTranslator',
    'SVSFParseMask', 'DISPID_SAFGuid', 'DISPID_SpeechAudioFormat',
    'SAFT32kHz16BitMono', 'SpeechAllElements', 'SREInterference',
    'DISPID_SPIGrammarId', 'ISpRecoGrammar2',
    'DISPID_SPPEngineConfidence', 'SLOStatic', 'DISPID_SRDisplayUI',
    'ISpeechPhraseReplacement', 'ISpeechGrammarRuleStateTransitions',
    'SPWAVEFORMATTYPE', 'DISPID_SLPPhoneIds', '__MIDL_IWinTypes_0009',
    'SDKLCurrentUser', 'ISpVoice', 'SPRULESTATE', 'SPVISEMES',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SDKEnumKeys',
    'SpPhoneticAlphabetConverter', 'SPAUDIOSTATE',
    'DISPID_SPRulesItem', 'STSF_AppData', 'SPLO_DYNAMIC',
    'SPEI_VOICE_CHANGE', 'SPRECOGNIZERSTATUS', 'SpWaveFormatEx',
    'DISPID_SGRSTsItem', 'SPGS_DISABLED', 'SPRST_ACTIVE',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPAStartElementInResult', 'SRTSMLTimeout',
    'DISPIDSPTSI_ActiveOffset', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPIRule', 'SDTAlternates', 'ISpeechObjectToken',
    'SAFTGSM610_8kHzMono', 'SVSFParseSapi', 'IStream', 'SVEViseme',
    'SPAR_High', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SPEAudioSizeBytes', 'SAFT12kHz16BitMono', 'SVP_1',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SGRsFindRule', 'SPSHORTCUTTYPE',
    'SLTApp', 'DISPID_SDKDeleteValue', 'SpInProcRecoContext',
    'SPEI_RESERVED3',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SASNonBlockingIO', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SLGenerationId', 'SAFT32kHz16BitStereo',
    'SPINTERFERENCE_NONE', 'SAFTADPCM_8kHzMono', 'DISPID_SVVoice',
    'SPWT_DISPLAY', 'eLEXTYPE_PRIVATE17', 'SpAudioFormat',
    'DISPID_SVWaitUntilDone', 'ISpRecoCategory', 'ISpeechPhraseRules',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpeechPhraseRule',
    'DISPID_SMSADeviceId', 'DISPID_SPEActualConfidence',
    'SGSExclusive', 'DISPID_SRCERequestUI',
    'DISPID_SpeechPhraseBuilder', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRGCmdLoadFromObject', 'SINone', 'SpeechCategoryAudioIn',
    'SpeechPropertyHighConfidenceThreshold', 'SPCT_COMMAND',
    'STCLocalServer', 'DISPID_SVSLastBookmarkId',
    'DISPID_SpeechRecoResultTimes',
    'DISPID_SRCERecognitionForOtherContext', 'SpeechRecoEvents',
    'SP_VISEME_21', 'SPPHRASE', 'ISpSerializeState', 'ISpEventSource',
    'SP_VISEME_19', 'DISPID_SRRTLength', 'SPEI_ADAPTATION',
    'DISPID_SRCRequestedUIType', 'DISPID_SRGSetWordSequenceData',
    'SVP_17', 'SPWORDPRONUNCIATION', 'eLEXTYPE_PRIVATE13',
    'eWORDTYPE_ADDED', 'DISPID_SRCBookmark', 'ISpeechRecoResultTimes',
    'SVP_19', 'ISpPhrase', 'SPAO_RETAIN_AUDIO',
    'DISPID_SRGSetTextSelection', 'SpResourceManager',
    'eLEXTYPE_RESERVED6', 'SAFTText', 'SSSPTRelativeToEnd',
    'DISPID_SOTCGetDataKey', 'SPXMLRESULTOPTIONS', 'SPSHT_OTHER',
    'DISPID_SPEDisplayText', 'SVP_15', 'SVP_12', 'SP_VISEME_9',
    'DISPID_SLGetWords', 'DISPID_SASCurrentDevicePosition',
    'SpObjectToken', 'SpeechRecognizerState', 'SPPS_SuppressWord',
    'DISPID_SOTGetDescription', 'SPSHT_Unknown', 'SDTDisplayText',
    'ISpeechAudioStatus', 'SSSPTRelativeToCurrentPosition',
    'SpeechStreamSeekPositionType', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPIStartTime', 'SpNullPhoneConverter', 'SPSHT_EMAIL',
    'SPSERIALIZEDRESULT', 'ISpeechPhraseInfo',
    'DISPID_SPISaveToMemory', 'SDKLLocalMachine',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SpeechLexiconWords',
    'SpeechAudioFormatGUIDWave', 'eLEXTYPE_PRIVATE11',
    'ISpeechGrammarRule', 'DISPID_SLPPartOfSpeech',
    'DISPID_SPCPhoneToId', 'ISpeechWaveFormatEx',
    'SAFT24kHz16BitMono', 'STCInprocHandler', 'SpeechRunState',
    'DISPID_SRStatus', 'SPPS_Verb', 'SVP_5', 'DISPID_SRSAudioStatus',
    'SPGS_EXCLUSIVE', 'DISPID_SRRTTickCount',
    'ISpeechAudioBufferInfo', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SpeechVoiceEvent', 'DISPID_SVSLastBookmark', 'SBONone',
    'SPBO_AHEAD', 'SVSFNLPSpeakPunc', 'ISpRecoGrammar',
    'DISPID_SVAudioOutputStream', 'SGDSInactive',
    'SpeechPropertyComplexResponseSpeed', 'SSFMCreate',
    'DISPID_SLWType', 'Speech_Max_Pron_Length', 'STCRemoteServer',
    'SREStateChange', 'DISPID_SGRSTPropertyValue',
    'SPEVENTSOURCEINFO', 'SAFT8kHz16BitMono', 'SPRST_ACTIVE_ALWAYS',
    'UINT_PTR', 'SpeechGrammarState', 'SPFM_NUM_MODES',
    'SAFTGSM610_22kHzMono', 'SPEI_RESERVED5',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRCEInterference',
    'SAFTADPCM_11kHzStereo', 'eLEXTYPE_PRIVATE6', 'SPCT_DICTATION',
    'SPEI_RESERVED1', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRGCmdSetRuleState', 'SECLowConfidence', 'SP_VISEME_14',
    'SPSHT_NotOverriden', 'tagSPPROPERTYINFO', 'WAVEFORMATEX',
    'SGRSTTWildcard', 'ISpeechRecoResultDispatch', 'SLODynamic',
    'DISPID_SVEVoiceChange', 'SP_VISEME_3', 'SPSModifier',
    '_RemotableHandle', 'DISPID_SOTCreateInstance',
    'DISPID_SABufferInfo', 'SAFT11kHz8BitStereo',
    'ISpeechGrammarRuleStateTransition', 'SpStreamFormatConverter',
    'SAFT16kHz16BitMono', 'SRAExport', 'SVP_4',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRSNumberOfActiveRules',
    'SpeechWordType', 'DISPID_SpeechObjectToken', 'SPAS_CLOSED',
    'eLEXTYPE_PRIVATE19', 'SPEI_PHONEME', 'DISPID_SPPChildren',
    'DISPID_SRProfile', 'SPPS_RESERVED4', 'SVP_7',
    'SpeechTokenKeyAttributes', 'DISPID_SVVolume',
    'DISPID_SPEPronunciation', 'DISPID_SpeechPhraseProperty',
    'SpTextSelectionInformation', 'SAFTGSM610_11kHzMono',
    'SpeechPropertyAdaptationOn', 'SPCT_SUB_COMMAND',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SMSAMMHandle',
    'DISPID_SVEStreamEnd', 'SpeechStreamFileMode', 'DISPID_SRGId',
    'DISPID_SOTCSetId', 'SAFTADPCM_44kHzStereo', 'SAFT48kHz8BitMono',
    'SpObjectTokenCategory', 'SpeechWordPronounceable', 'SINoSignal',
    'ISpNotifySink', 'SRAONone', 'SDTPronunciation',
    'DISPID_SRCPause', 'SAFT11kHz8BitMono',
    ...
    'DISPID_SPEAudioTimeOffset', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SGRs_NewEnum', 'SREAdaptation', 'SpeechUserTraining',
    'SPRECOCONTEXTSTATUS', 'DISPID_SLPLangId',
    '_ISpeechRecoContextEvents', 'ISpeechResourceLoader',
    'DISPID_SABIMinNotification', 'DISPID_SPAs_NewEnum',
    'SpeechVoiceSpeakFlags', 'SECFIgnoreCase',
    'DISPID_SpeechPhraseRules', 'SAFT44kHz8BitMono',
    'SAFT44kHz16BitMono', 'SPINTERFERENCE_TOOFAST', 'SITooLoud',
    'DISPID_SAEventHandle', 'SAFTNonStandardFormat',
    'DISPID_SRRPhraseInfo', 'DISPID_SpeechGrammarRuleState',
    'SWPUnknownWordPronounceable', 'DISPID_SVEStreamStart',
    'SVEPrivate', 'DISPID_SRIsShared', 'SGRSTTEpsilon',
    'DISPID_SPRs_NewEnum', 'SPFM_CREATE', 'ISpeechDataKey',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRSRule',
    'SAFT11kHz16BitMono', 'SAFT16kHz8BitStereo',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SGRSTPropertyName',
    'SRATopLevel', 'SGLexicalNoSpecialChars', 'SFTInput', 'SPXRO_SML',
    'DISPID_SRAudioInput', 'SpeechAudioFormatGUIDText', 'SGDisplay',
    'SVP_9', 'DISPID_SRCCreateGrammar', 'eLEXTYPE_RESERVED10',
    'DISPID_SPRuleEngineConfidence', 'ISpeechRecoResult', 'SDTRule',
    'eLEXTYPE_LETTERTOSOUND', 'eLEXTYPE_PRIVATE3', '_SPAUDIOSTATE',
    'DISPID_SRSetPropertyString', 'SDA_Two_Trailing_Spaces',
    'DISPID_SRAudioInputStream', 'DISPID_SRSClsidEngine',
    'eLEXTYPE_PRIVATE18', 'SpeechDisplayAttributes',
    'Speech_StreamPos_RealTime', 'DISPID_SRCEAdaptation',
    'ISpPhoneConverter', 'SSFMOpenForRead',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SVAlertBoundary',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SLPType',
    'SPDATAKEYLOCATION', 'SVSFPurgeBeforeSpeak',
    'SAFTCCITT_uLaw_22kHzStereo', 'SREPropertyNumChange',
    'DISPID_SPRNumberOfElements', 'SVSFIsXML',
    'DISPID_SRGetRecognizers', 'SpeechAudioFormatType',
    'SGDSActiveWithAutoPause', 'DISPID_SPIGetText',
    'DISPID_SRCERecognition', 'ISpPhoneticAlphabetSelection',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRGDictationLoad', 'ISpLexicon',
    'SAFT24kHz8BitStereo', 'ISpStreamFormatConverter', 'SRTStandard',
    'SECFIgnoreKanaType', 'DISPID_SPARecoResult',
    'DISPID_SpeechLexicon', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SRCESoundEnd', 'DISPID_SPRText', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechWaveFormatEx', 'SPWF_INPUT', 'SP_VISEME_10',
    'DISPID_SpeechObjectTokens', 'DISPID_SGRId', 'ISpRecognizer3',
    'DISPID_SOTsCount', 'eLEXTYPE_PRIVATE2',
    'DISPID_SpeechGrammarRules', 'DISPID_SRGRules', 'ISpMMSysAudio',
    'DISPID_SRCEEnginePrivate', 'SASRun', 'SPPHRASEREPLACEMENT',
    'SP_VISEME_16', 'SREPropertyStringChange',
    'SpeechPropertyResourceUsage', 'SP_VISEME_20',
    'DISPID_SPERetainedSizeBytes', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPAS_STOP', 'SVP_3', 'SAFT24kHz8BitMono',
    'DISPID_SPIReplacements', 'ISpeechPhraseAlternates',
    'ISpRecoContext2', 'SDA_Consume_Leading_Spaces',
    'SVEEndInputStream', 'SP_VISEME_8', 'DISPID_SpeechPhraseElement',
    'SAFT48kHz8BitStereo', 'SpMMAudioIn', 'DISPID_SPRules_NewEnum',
    'SVSFlagsAsync', 'SDTProperty', 'SRCS_Disabled', 'SASClosed',
    'DISPID_SVEPhoneme', 'SRSEIsSpeaking', 'SPEI_TTS_BOOKMARK',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SPERequiredConfidence', 'DISPID_SpeechVoice',
    'DISPID_SGRAddResource', 'ISpeechObjectTokens',
    'DISPID_SRGIsPronounceable', 'SDTAudio',
    'DISPID_SVSLastStreamNumberQueued', 'SPRECOSTATE',
    'ISpeechPhraseInfoBuilder', 'SVPAlert', 'SpeechTokenContext',
    'SVPNormal', 'DISPID_SRRSetTextFeedback', 'DISPID_SRGState',
    'SPSEMANTICERRORINFO', 'SPBO_PAUSE', 'SP_VISEME_7',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechCategoryAudioOut',
    'SRADefaultToActive', 'IInternetSecurityManager',
    'DISPID_SVSpeak', 'DISPID_SPEAudioSizeTime', 'SVP_6',
    'SPSInterjection', 'DISPID_SPPsCount',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SVIsUISupported',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'STSF_LocalAppData',
    'SpeechEngineProperties', 'DISPID_SDKSetStringValue',
    'SAFT32kHz8BitMono', 'DISPID_SGRsItem', 'SPSMF_UPS',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SVResume',
    'SPEI_SOUND_END', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SRCreateRecoContext', 'DISPID_SpeechPhoneConverter',
    'DISPID_SVSInputWordLength', 'SSFMOpenReadWrite',
    'ISpeechPhraseProperties', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPEsItem', 'SPAUDIOOPTIONS', 'DISPID_SBSFormat',
    'SPRS_INACTIVE', 'SVSFPersistXML', 'SVEAudioLevel',
    'ISpeechPhraseReplacements', 'SPPS_Function',
    'DISPID_SRCEHypothesis', 'DISPID_SPPName',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPEAudioStreamOffset',
    'ISpeechRecognizerStatus', 'SPPS_Modifier', 'DISPID_SOTCId',
    'DISPID_SRRecognizer', 'DISPID_SPANumberOfElementsInResult',
    'SAFT8kHz8BitMono', 'DISPID_SMSSetData', 'SAFT8kHz16BitStereo',
    'SAFT11kHz16BitStereo', 'DISPID_SRRGetXMLResult', 'SPEI_MAX_TTS',
    'SPPHRASERULE', 'ISequentialStream', 'DISPID_SPPNumberOfElements',
    'SVEBookmark', 'SRERequestUI', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SpeechPhraseAlternate', 'SDTLexicalForm', 'SVF_Stressed',
    'DISPID_SPPParent', 'DISPID_SRIsUISupported', 'eLEXTYPE_PRIVATE4',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRCVoicePurgeEvent',
    'SAFT16kHz8BitMono', 'eLEXTYPE_PRIVATE8', 'SpeechVoicePriority',
    'SVSFNLPMask', 'SPPS_RESERVED2', 'ISpeechMMSysAudio',
    'DISPID_SPACommit', 'SREHypothesis', 'ISpNotifyTranslator',
    'SPEI_WORD_BOUNDARY', 'SPPHRASEPROPERTY', 'SREStreamEnd',
    'DISPID_SWFESamplesPerSec', 'SPPARTOFSPEECH', 'SpMMAudioEnum',
    ...
    'SSTTDictation', 'SSTTWildcard', 'SPPHRASEELEMENT',
    'SpeechCategoryRecoProfiles', 'SPVPRI_NORMAL',
    'DISPID_SOTMatchesAttributes', 'SVP_14', 'SpeechTokenKeyUI',
    'SECFDefault', 'SVSFIsNotXML', 'DISPID_SPIElements',
    'DISPID_SGRName', 'SPCONTEXTSTATE', 'DISPID_SGRsCommit',
    'SPCT_SUB_DICTATION', 'eLEXTYPE_PRIVATE12', 'SREStreamStart',
    'DISPID_SOTRemove', 'SREFalseRecognition', 'SPFM_OPEN_READONLY',
    'SpeechRuleAttributes', 'SPRST_INACTIVE_WITH_PURGE',
    'SPVOICESTATUS', 'DISPID_SVSkip', 'DISPID_SPAPhraseInfo',
    'SRTAutopause', 'DISPID_SOTCEnumerateTokens', 'DISPID_SOTSetId',
    'SVP_20', 'DISPID_SOTId', 'SAFTADPCM_22kHzStereo',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRCResume',
    'SPEI_REQUEST_UI', 'DISPID_SpeechRecognizerStatus',
    'SPBOOKMARKOPTIONS', 'ISpeechTextSelectionInformation',
    'DISPID_SpeechAudio', 'SPAS_PAUSE', 'SPWORDTYPE', 'SREPrivate',
    'SpeechLoadOption', 'SVP_8',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPWT_PRONUNCIATION',
    'SPEI_MAX_SR', 'DISPID_SRRTStreamTime', 'SVP_21',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpEventSink', 'SpShortcut',
    'DISPID_SPPId', 'SSTTTextBuffer', 'DISPID_SGRSTNextState',
    'DISPID_SpeechRecoContext', 'SRERecognition',
    'eLEXTYPE_PRIVATE10', 'SPFILEMODE', 'SPEI_PHRASE_START',
    'DISPID_SRSetPropertyNumber', 'ISpeechPhraseElement', 'SPBO_NONE',
    'DISPID_SDKDeleteKey', 'SpeechLexiconType',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SRSActiveAlways',
    'eWORDTYPE_DELETED', 'SPRST_INACTIVE', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRCEventInterests', 'DISPID_SpeechGrammarRule',
    'eLEXTYPE_PRIVATE1', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SOTsItem', 'IEnumSpObjectTokens',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRSTText',
    'SAFTADPCM_8kHzStereo', 'SpPhraseInfoBuilder',
    'SpeechTokenKeyFiles', 'DISPID_SpeechVoiceStatus',
    'SVESentenceBoundary', 'SRAInterpreter', 'Speech_Max_Word_Length',
    'DISPID_SpeechMMSysAudio', 'SpeechVoiceEvents',
    'DISPID_SPPs_NewEnum', 'ISpeechLexiconWord',
    'ISpeechCustomStream', 'SPINTERFERENCE_NOISE',
    'ISpeechFileStream', 'SpVoice', 'SFTSREngine', 'DISPID_SRGReset',
    'SECFEmulateResult', 'SAFT12kHz8BitMono', 'SAFT44kHz8BitStereo',
    'DISPID_SRGCmdLoadFromFile', 'ISpShortcut', 'SVPOver',
    'SAFT12kHz16BitStereo', 'SPAR_Low', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPRDisplayAttributes', 'SAFT22kHz16BitStereo',
    'DISPID_SRRDiscardResultInfo', 'SpLexicon',
    'DISPIDSPTSI_SelectionOffset', 'SRTReSent', 'IEnumString',
    'DISPID_SLGetPronunciations', 'SPEI_UNDEFINED', 'SpFileStream',
    'DISPID_SGRAttributes', 'SpeechAddRemoveWord',
    'DISPID_SpeechBaseStream', 'DISPID_SpeechAudioBufferInfo',
    'SPPROPERTYINFO', 'SRAImport', 'SVF_None', 'SSSPTRelativeToStart',
    'DISPID_SLWsCount', 'DISPID_SVEViseme', 'SVSFParseAutodetect',
    'ISpeechPhraseAlternate', 'ISpAudio', 'SPWF_SRENGINE',
    'DISPID_SVEAudioLevel', 'SPINTERFERENCE', 'SPSNoun',
    'SGPronounciation', 'SREAllEvents', 'SPSHORTCUTPAIR',
    'SpeechCategoryRecognizers', 'SpeechAudioProperties',
    'SPCATEGORYTYPE', 'DISPID_SDKSetLongValue', 'ISpeechLexiconWords',
    'DISPID_SpeechCustomStream', 'SVSFIsFilename', 'DISPID_SFSClose',
    'SAFT48kHz16BitStereo', 'SPLOADOPTIONS',
    'SpeechGrammarTagWildcard', 'SPEI_VISEME', 'SPPS_LMA',
    'SpeechEngineConfidence', 'SP_VISEME_4', 'SGRSTTTextBuffer',
    'DISPID_SRRRecoContext', 'DISPID_SPIProperties',
    'DISPID_SPEDisplayAttributes', 'SDA_No_Trailing_Space',
    'SpeechEmulationCompareFlags', 'DISPID_SBSSeek',
    'DISPID_SRCEStartStream', 'DISPID_SPELexicalForm',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPIDSPRG', 'ISpNotifySource',
    'DISPID_SVEBookmark', 'SGSDisabled', 'SpeechRegistryUserRoot',
    'DISPID_SLGetGenerationChange', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechRecognizer', 'ISpObjectWithToken',
    'DISPID_SRCEEndStream', 'DISPID_SRRAudio', 'SAFT24kHz16BitStereo',
    'SPEI_INTERFERENCE', 'ISpStream', 'ISpeechLexicon',
    'SVEStartInputStream', 'DISPID_SPPFirstElement',
    'SVSFUnusedFlags', 'SPCT_SLEEP', 'ISpRecognizer',
    'ISpGrammarBuilder', 'SPEI_RECOGNITION', 'ISpPhraseAlt',
    'DISPID_SRCEPhraseStart', 'DISPID_SDKCreateKey',
    'DISPID_SLPSymbolic', 'DISPID_SPIEngineId',
    'DISPID_SRRAlternates', 'DISPID_SOTDisplayUI', 'SINoise',
    'DISPID_SPRuleFirstElement', 'DISPID_SPIAudioSizeBytes',
    'SPEI_RECO_OTHER_CONTEXT', 'SPGS_ENABLED', 'SVSFParseSsml',
    'SPVPRI_ALERT', 'ISpRecoContext', 'SRSInactive', 'SPEI_MIN_TTS',
    'DISPID_SOTGetStorageFileName', 'DISPID_SADefaultFormat',
    'SPCS_DISABLED', 'DISPID_SpeechObjectTokenCategory',
    'ISpeechPhoneConverter', 'DISPID_SRRSpeakAudio',
    'ISpStreamFormat', 'DISPID_SpeechRecoResult2', 'SPEI_RESERVED6',
    ...
    'DISPID_SpeechAudioStatus', 'eLEXTYPE_MORPHOLOGY',
    'SPRECORESULTTIMES', 'SPPS_Noun', 'SP_VISEME_12',
    'DISPID_SBSRead', 'SP_VISEME_17', 'SAFTNoAssignedFormat',
    'DISPID_SpeechPhraseAlternates',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVDisplayUI',
    'SPLEXICONTYPE', 'SAFTADPCM_11kHzMono', 'SRESoundEnd',
    'SpeechTokenIdUserLexicon', 'eLEXTYPE_PRIVATE9', 'SPAUDIOSTATUS',
    'SPEVENTENUM', 'SPBINARYGRAMMAR', 'DISPID_SABIEventBias',
    'DISPID_SRCEFalseRecognition', 'DISPID_SVGetVoices',
    'DISPID_SPRuleName', 'ISpRecoResult', 'SVSFDefault',
    'DISPID_SDKGetlongValue', 'DISPID_SVAudioOutput', 'SPEI_MIN_SR',
    'SpPhoneConverter', 'SPPS_RESERVED3',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SVSInputWordPosition',
    'tagSTATSTG', 'DISPID_SPPConfidence', 'SP_VISEME_13',
    'SpMMAudioOut', 'ISpRecognizer2', 'DISPID_SREmulateRecognition',
    'SRARoot', 'SASStop', 'DISPID_SRCState', 'DISPID_SOTGetAttribute',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechPhraseProperty',
    'DISPID_SPPsItem', 'STCAll', 'SpSharedRecoContext',
    'DISPID_SVGetProfiles', 'SPEVENT', 'SREBookmark',
    'DISPID_SPEEngineConfidence', 'DISPID_SDKEnumValues',
    'SRESoundStart', 'SECFIgnoreWidth', 'DISPID_SRGDictationUnload',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SGRSTPropertyId',
    'SPEI_END_SR_STREAM', 'DISPID_SPCLangId', 'SAFT22kHz16BitMono',
    'DISPID_SVSpeakStream', 'DISPID_SVEventInterests',
    'SDKLCurrentConfig', 'SpStream', 'DISPID_SDKGetStringValue',
    'DISPID_SFSOpen', 'DISPID_SDKSetBinaryValue', 'SPPS_NotOverriden',
    'ISpeechLexiconPronunciation', 'SpeechPartOfSpeech', 'SVEPhoneme',
    'SPAR_Medium', 'SDA_One_Trailing_Space',
    'ISpeechLexiconPronunciations', 'DISPID_SWFEFormatTag',
    'DISPID_SPRuleId', 'DISPID_SpeechRecoResult', 'DISPID_SRState',
    'DISPID_SBSWrite', 'DISPID_SPRsItem', 'DISPID_SPRFirstElement',
    'eLEXTYPE_PRIVATE5', 'SVP_10', 'eLEXTYPE_USER',
    'DISPID_SRRGetXMLErrorInfo', 'SAFTCCITT_ALaw_11kHzMono'
]
